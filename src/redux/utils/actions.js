...
export const REDUCE_PRODUCT_FROM_ORDER = "REDUCE_PRODUCT_FROM_ORDER";
export const REMOVE_PRODUCT_FROM_ORDER = "REMOVE_PRODUCT_FROM_ORDER";

// SIGNALR

export const ADD_ORDER_SIGNALR = "ADD_ORDER_SIGNALR";
export const UPDATE_ORDER_SIGNALR = "UPDATE_ORDER_SIGNALR";
export const FETCH_ORDERS = "FETCH_ORDERS";
export const UPDATE_ORDER_DETAILS_STATE = "UPDATE_ORDER_DETAILS_STATE";

// REPORTING

// INVENTORY
export const GENERATE_CURRENT_INVENTORY = "GENERATE_CURRENT_INVENTORY";
export const GENERATE_SPECIFIC_DATE_INVENTORY = "GENERATE_SPECIFIC_DATE_INVENTORY";
export const GENERATE_DATE_RANGE_INVENTORY = "GENERATE_DATE_RANGE_INVENTORY";

// SALES
export const GENERATE_SPECIFIC_DATE_SALES = "GENERATE_SPECIFIC_DATE_SALES";
export const GENERATE_DATE_RANGE_SALES = "GENERATE_DATE_RANGE_SALES";
